...
requiredConfig = {'server': ['port'], 
                  ...
                  'api':['user', 'pass'], 
                  'postgrest':['rundeck_resources_url', 'host_aliases_url', 'entity_metadata_url', 'instance_url', 'volume_url', 'attribute_url', 'functional_alias_url', 'cluster_url', 'cluster_attribute_url'],
