...
class FunctionalAliasTest(AsyncHTTPTestCase):
    ...
    def test_get_single_alias_by_name(self):
        ...
        response = self.fetch("/api/v1/instance/alias/%s" %(db_name_test))
    ...
    def test_invalid_endpoint(self):
        ...
        response = self.fetch("/api/v1/instance/something/some_db")
        self.assertEquals(response.code, 404)
    ...
    def test_post_valid_request(self):
        ...
        self.assertEquals(response.code, 200)
        self.fetch("/api/v1/instance/alias/dbod_42", 
                   method="DELETE")
    ...
    def test_delete_valid_request(self):
        ...
        response = self.fetch("/api/v1/instance/alias/", 
                              ...
                              body=body, 
                              headers=self.headers)
        response = self.fetch("/api/v1/instance/alias/dbod_42", 
                              method="DELETE")
        self.assertEquals(response.code, 200)
