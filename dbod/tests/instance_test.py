...
class InstanceTest(AsyncHTTPTestCase):
    ...
    def test_create_instance(self):
        ...
        "version": "5.6.17", "instance_type_id": 2, "host_id": 1, "name": "testdb", "state": "MAINTENANCE", "status": "ACTIVE",
        "volumes": [
    ...
    def test_create_basic_instance(self):
        ...
        instance = """{
        "owner": "testuser", "category": "TEST", "creation_date":"2016-07-20",
        "version": "5.6.17", "instance_type_id": 2, "db_size": "100", "host_id": 1, "name": "testdb", "state": "MAINTENANCE", "status": "ACTIVE"
        }"""
