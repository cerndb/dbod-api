...
class InstanceTest(AsyncHTTPTestCase):
    ...
    def test_create_instance(self):
        ...
        "version": "5.6.17", "instance_type_id": 2, "hosts": ["testhost"], "name": "testdb", "state": "MAINTENANCE", "status": "ACTIVE",
        "volumes": [
        ...
        created_id = json.loads(response.body)["insert_instance"]
        ...
        response = self.fetch("/api/v1/instance/" + created_id, method='DELETE', headers={'Authorization': self.authentication})
    ...
    def test_create_basic_instance(self):
        ...
        instance = """{
        "owner": "testuser", "category": "TEST", "creation_date":"2016-07-20",
        "version": "5.6.17", "instance_type_id": 2, "db_size": "100", "hosts": ["testhost"], "name": "testdb", "state": "MAINTENANCE", "status": "ACTIVE"
        }"""
        ...
        self.assertEquals(data[0]["instance_type_id"], 2)
